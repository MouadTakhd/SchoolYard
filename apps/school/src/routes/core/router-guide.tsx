  ...
  return (
    <main className="space-y-10 pb-10 text-foreground">
      ...
      <section
        ...
        className="relative overflow-hidden rounded-3xl border border-border/60 bg-card/60 p-6 sm:p-8 md:p-10 backdrop-blur-xl"
      >
...
function Section({
  ...
  return (
    <Card className="overflow-hidden rounded-3xl border-border/60 bg-card/70 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
...
function InfoItem({
  ...
  return (
    <div className="flex items-start gap-3 rounded-2xl border border-border bg-card/50 p-4 transition-all hover:-translate-y-1 hover:border-primary/20 hover:bg-muted/30">
      <span
...
function Step({
  ...
  return (
    <div className="group flex items-start gap-4 rounded-2xl border border-border bg-card/50 p-4 transition-all hover:-translate-y-1 hover:border-primary/20 hover:bg-muted/40">
      <Badge
...
function Rule({
  ...
  return (
    <div className="rounded-2xl border border-border bg-card/50 p-4 transition-all duration-300 hover:-translate-y-1 hover:border-primary/20 hover:bg-muted/40">
      <div className="space-y-3">
