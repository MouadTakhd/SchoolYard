  ...
  ${badgeLabel}
      ...
      >
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card className="border-dashed hover:-translate-y-1 hover:shadow-xl transition-all">
            <CardHeader>
          ...
          <Card className="bg-muted/40 hover:-translate-y-1 hover:shadow-xl transition-all">
            <CardHeader>
