      ...
      >
        <div className="grid gap-4 sm:grid-cols-2">
          {[
            ...
            <div
              key={item}
              className="group rounded-2xl border border-border bg-card/50 p-4 transition-all hover:-translate-y-1 hover:border-primary/20 hover:bg-muted/40"
            >
      ...
      >
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
          {[
            ...
            <div
              key={tech}
              className="rounded-2xl border border-border bg-card/50 p-4 text-center text-sm font-medium transition-all hover:-translate-y-1 hover:border-primary/20 hover:bg-muted/40"
            >
              {tech}
            </div>
          ))}
...
function TechBadge({
  ...
  return (
    <Badge
      className={`rounded-full border px-3 py-1 transition-all hover:scale-105 ${colorMap[color]}`}
    >
      {label}
    </Badge>
  )
